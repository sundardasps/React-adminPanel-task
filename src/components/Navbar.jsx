...
import { Navbar as Nav, Button } from "@material-tailwind/react";
    ...
    <>
      <Nav className=" mx-auto max-w-screen-xxl px-4   lg:py-4 shadow-none rounded-none  ">
        <div className=" mx-auto flex items-center justify-between  h-20 ">
          ...
          <div className=" hidden  md:block  w-1/2  mr-16  ">
            <img
              src={Logo}
              className=" h-[70px] w-[200px] object-cover  "
              alt=""
            />
          </div>
          <div className="absolute flex  w-[10rem] right-0  ">
            ...
            <ul
              className={`absolute ${
                button ? "block" : "hidden"
              }  top-14  text-white z-10 min-w-[150px] bg-[#C91416]  overflow-auto rounded-2xl border  py-3 font-sans text-sm font-normal  shadow-lg`}
            >
              <li
                onClick={() => handleButton()}
      ...
      {openNav && (
        <div
          className={`absolute top-0 z-50 bg-black  md:hidden  text-black h-max  w-screen`}
        >
          <svg
            width="51"
            height="50"
